...
import com.demo.expensetrackingapi.repositories.TransactionRepository;
...
public class TransactionServiceImpl implements TransactionService{
    ...
    @Override
    public Transaction fetchTransactionById(Integer userId, Integer category, Integer transactionId) throws EtResourceNotFoundException {
        return transactionRepository.findById(userId, category, transactionId);
    }
    ...
    public void removeTransaction(Integer userId, Integer categoryId, Integer transactionId) throws EtResourceNotFoundException {
        transactionRepository.removeId(userId, categoryId, transactionId);
    }
}
