...
public class CategoryRepositoryImpl implements CategoryRepository{
    ...
    public List<Category> findAll(Integer userId) throws EtResourceNotFoundException {
        return jdbcTemplate.query(SQL_FIND_ALL, new Object[]{userId}, categoryMapper);
    }

    @Override
    public Category findById(Integer userId, Integer categoryId) throws EtResourceNotFoundException {
        try{
            return jdbcTemplate.queryForObject(SQL_FIND_BY_ID, new Object[]{userId, categoryId}, categoryMapper);
        } catch (Exception e){
    ...
    private RowMapper<Category> categoryMapper = ((rs, rowNum) -> {
