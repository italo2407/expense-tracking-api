...
public class TransactionRepositoryImpl implements TransactionRepository{
    ...
    public List<Transaction> findAll(Integer userId, Integer categoryId) {
        return jdbcTemplate.query(SQL_FIND_ALL, new Object[]{userId, categoryId}, transactionMapper);
    }
    ...
    @Override
    public void removeId(Integer userId, Integer categoryId, Integer transactionId) throws EtResourceNotFoundException {
    ...
    private RowMapper<Transaction> transactionMapper = ((rs, rowNum) -> {
